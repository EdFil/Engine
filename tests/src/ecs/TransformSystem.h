...
struct TransformComponent {
    ...
    void operator=(const TransformComponent& rhs) { DP_TRANSFORM(std::cout << "[TransformComponent::CopyAssignmentOperator]" << std::endl;) x = rhs.x; y = rhs.y;  z = rhs.z; }
    void operator=(const TransformComponent&& rhs) noexcept { DP_TRANSFORM(std::cout << "[TransformComponent::MoveAssignmentOperator]" << std::endl;) x = rhs.x; y = rhs.y;  z = rhs.z; }
...
public:
    ...
    void initWith(size_t capacity) final override {
